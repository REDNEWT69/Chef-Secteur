(function(){
  ...
  function installHook(){if(window.__workdayEnforcer||typeof window.generateWeek!=='function')return false;const base=window.generateWeek;window.generateWeek=function(){return base.apply(this,arguments)};window.__workdayEnforcer=true;return true}
