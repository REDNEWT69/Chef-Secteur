...
const api={capture,validate,validateState,decode,backups,checkpoint,recover,persist,load,save,restore,planIssues,keys:{MAIN,ARCHIVE,RANGE,BACKUPS,JOURNAL,EXPORT,CATALOG}};
