...
assert.strictEqual(version.displayVersion, '196');
assert.strictEqual(version.latestBuild, '20260917-anonresidus196');
assert(index.includes("const BUILD_REV='20260917-anonresidus196'"));
assert(sw.includes('const BUILD_REV = "20260917-anonresidus196"'));
