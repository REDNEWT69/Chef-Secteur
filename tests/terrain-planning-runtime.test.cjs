...
assert.strictEqual(version.displayVersion, '205');
assert.strictEqual(version.latestBuild, '20260917-planningtoday205');
assert(index.includes("const BUILD_REV='20260917-planningtoday205'"));
assert(sw.includes('const BUILD_REV = "20260917-planningtoday205"'));
