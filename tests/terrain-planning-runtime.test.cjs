...
assert.strictEqual(version.displayVersion, '176');
assert.strictEqual(version.latestBuild, '20260915-boulanger176');
assert(index.includes("const BUILD_REV='20260915-boulanger176'"));
assert(sw.includes('const BUILD_REV = "20260915-boulanger176"'));
