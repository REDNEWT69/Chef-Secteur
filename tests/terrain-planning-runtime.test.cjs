...
assert.strictEqual(version.displayVersion, '166');
assert.strictEqual(version.latestBuild, '20260914-updatereload166');
assert(index.includes("const BUILD_REV='20260914-updatereload166'"));
assert(sw.includes('const BUILD_REV = "20260914-updatereload166"'));
