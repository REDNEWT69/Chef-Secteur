...
assert.strictEqual(version.displayVersion, '161');
assert.strictEqual(version.latestBuild, '20260913-updatereload161');
assert(index.includes("const BUILD_REV='20260913-updatereload161'"));
assert(sw.includes('const BUILD_REV = "20260913-updatereload161"'));
