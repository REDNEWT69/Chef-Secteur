...
assert.strictEqual(version.displayVersion, '188');
assert.strictEqual(version.latestBuild, '20260916-routeintel188');
assert(index.includes("const BUILD_REV='20260916-routeintel188'"));
assert(sw.includes('const BUILD_REV = "20260916-routeintel188"'));
