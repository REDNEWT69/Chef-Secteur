...
assert.strictEqual(version.displayVersion, '162');
assert.strictEqual(version.latestBuild, '20260913-storehistory162');
assert(index.includes("const BUILD_REV='20260913-storehistory162'"));
assert(sw.includes('const BUILD_REV = "20260913-storehistory162"'));
