...
assert.strictEqual(version.displayVersion, '170');
assert.strictEqual(version.latestBuild, '20260915-terrainnotes170');
assert(index.includes("const BUILD_REV='20260915-terrainnotes170'"));
assert(sw.includes('const BUILD_REV = "20260915-terrainnotes170"'));
