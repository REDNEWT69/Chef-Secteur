...
assert.strictEqual(version.latestBuild, '20260913-settings161');
assert(index.includes("const BUILD_REV='20260913-settings161'"));
assert(sw.includes('const BUILD_REV = "20260913-settings161"'));
