...
assert.strictEqual(version.displayVersion, '203');
assert.strictEqual(version.latestBuild, '20260917-overnightbadge203');
assert(index.includes("const BUILD_REV='20260917-overnightbadge203'"));
assert(sw.includes('const BUILD_REV = "20260917-overnightbadge203"'));
