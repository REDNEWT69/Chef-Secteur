...
assert.strictEqual(version.latestBuild, '20260917-nightcue206');
assert(index.includes("const BUILD_REV='20260917-nightcue206'"));
assert(sw.includes('const BUILD_REV = "20260917-nightcue206"'));
