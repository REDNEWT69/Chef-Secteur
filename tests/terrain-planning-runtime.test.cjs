...
assert.strictEqual(version.displayVersion, '204');
assert.strictEqual(version.latestBuild, '20260917-smarthome204');
assert(index.includes("const BUILD_REV='20260917-smarthome204'"));
assert(sw.includes('const BUILD_REV = "20260917-smarthome204"'));
