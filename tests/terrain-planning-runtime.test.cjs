...
assert.strictEqual(version.displayVersion, '174');
assert.strictEqual(version.latestBuild, '20260915-manualplanning174');
assert(index.includes("const BUILD_REV='20260915-manualplanning174'"));
assert(sw.includes('const BUILD_REV = "20260915-manualplanning174"'));
