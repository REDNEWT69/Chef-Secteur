...
assert.strictEqual(version.displayVersion, '194');
assert.strictEqual(version.latestBuild, '20260916-aistore194');
assert(index.includes("const BUILD_REV='20260916-aistore194'"));
assert(sw.includes('const BUILD_REV = "20260916-aistore194"'));
