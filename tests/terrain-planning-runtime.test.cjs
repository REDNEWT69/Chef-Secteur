...
assert.strictEqual(version.displayVersion, '165');
assert.strictEqual(version.latestBuild, '20260914-visitcredits165');
assert(index.includes("const BUILD_REV='20260914-visitcredits165'"));
assert(sw.includes('const BUILD_REV = "20260914-visitcredits165"'));
