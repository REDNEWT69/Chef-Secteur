...
assert.strictEqual(version.displayVersion, '193');
assert.strictEqual(version.latestBuild, '20260916-cuisiniste193');
assert(index.includes("const BUILD_REV='20260916-cuisiniste193'"));
assert(sw.includes('const BUILD_REV = "20260916-cuisiniste193"'));
