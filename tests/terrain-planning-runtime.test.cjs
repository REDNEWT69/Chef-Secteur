...
assert.strictEqual(version.displayVersion, '201');
assert.strictEqual(version.latestBuild, '20260917-photomove201');
assert(index.includes("const BUILD_REV='20260917-photomove201'"));
assert(sw.includes('const BUILD_REV = "20260917-photomove201"'));
