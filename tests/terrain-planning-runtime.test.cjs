...
assert.strictEqual(version.displayVersion, '164');
assert.strictEqual(version.latestBuild, '20260913-storephotos164');
assert(index.includes("const BUILD_REV='20260913-storephotos164'"));
assert(sw.includes('const BUILD_REV = "20260913-storephotos164"'));
