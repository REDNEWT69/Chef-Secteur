...
assert.strictEqual(version.displayVersion, '177');
assert.strictEqual(version.latestBuild, '20260915-recalculate177');
assert(index.includes("const BUILD_REV='20260915-recalculate177'"));
assert(sw.includes('const BUILD_REV = "20260915-recalculate177"'));
