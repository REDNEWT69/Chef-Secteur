...
assert.strictEqual(version.displayVersion, '172');
assert.strictEqual(version.latestBuild, '20260915-ai-report172');
assert(index.includes("const BUILD_REV='20260915-ai-report172'"));
assert(sw.includes('const BUILD_REV = "20260915-ai-report172"'));
