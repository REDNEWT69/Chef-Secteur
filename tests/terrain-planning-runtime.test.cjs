...
assert.strictEqual(version.displayVersion, '167');
assert.strictEqual(version.latestBuild, '20260915-family167');
assert(index.includes("const BUILD_REV='20260915-family167'"));
assert(sw.includes('const BUILD_REV = "20260915-family167"'));
