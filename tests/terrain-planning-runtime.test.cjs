...
assert.strictEqual(version.displayVersion, '200');
assert.strictEqual(version.latestBuild, '20260917-opportunity200');
assert(index.includes("const BUILD_REV='20260917-opportunity200'"));
assert(sw.includes('const BUILD_REV = "20260917-opportunity200"'));
