...
assert.strictEqual(version.displayVersion, '175');
assert.strictEqual(version.latestBuild, '20260915-storecontacts175');
assert(index.includes("const BUILD_REV='20260915-storecontacts175'"));
assert(sw.includes('const BUILD_REV = "20260915-storecontacts175"'));
