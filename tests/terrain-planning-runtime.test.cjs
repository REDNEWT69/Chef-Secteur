...
assert.strictEqual(version.displayVersion, '186');
assert.strictEqual(version.latestBuild, '20260916-unifiedweek186');
assert(index.includes("const BUILD_REV='20260916-unifiedweek186'"));
assert(sw.includes('const BUILD_REV = "20260916-unifiedweek186"'));
