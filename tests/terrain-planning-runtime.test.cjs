...
assert.strictEqual(version.displayVersion, '189');
assert.strictEqual(version.latestBuild, '20260916-storecontrol189');
assert(index.includes("const BUILD_REV='20260916-storecontrol189'"));
assert(sw.includes('const BUILD_REV = "20260916-storecontrol189"'));
