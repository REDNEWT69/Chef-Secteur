...
assert.strictEqual(version.displayVersion, '199');
assert.strictEqual(version.latestBuild, '20260917-nearbysuggest199');
assert(index.includes("const BUILD_REV='20260917-nearbysuggest199'"));
assert(sw.includes('const BUILD_REV = "20260917-nearbysuggest199"'));
