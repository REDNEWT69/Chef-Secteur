...
assert.strictEqual(version.displayVersion, '198');
assert.strictEqual(version.latestBuild, '20260917-anonlibelles198');
assert(index.includes("const BUILD_REV='20260917-anonlibelles198'"));
assert(sw.includes('const BUILD_REV = "20260917-anonlibelles198"'));
