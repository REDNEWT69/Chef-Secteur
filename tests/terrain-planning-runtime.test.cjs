...
assert.strictEqual(version.displayVersion, '202');
assert.strictEqual(version.latestBuild, '20260917-glassnearby202');
assert(index.includes("const BUILD_REV='20260917-glassnearby202'"));
assert(sw.includes('const BUILD_REV = "20260917-glassnearby202"'));
