...
assert.strictEqual(version.displayVersion, '171');
assert.strictEqual(version.latestBuild, '20260915-quicksheet171');
assert(index.includes("const BUILD_REV='20260915-quicksheet171'"));
assert(sw.includes('const BUILD_REV = "20260915-quicksheet171"'));
