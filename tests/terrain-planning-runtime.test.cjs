...
assert.strictEqual(version.displayVersion, '156');
assert.strictEqual(version.latestBuild, '20260913-assistarchive156');
assert(index.includes("const BUILD_REV='20260913-assistarchive156'"));
assert(sw.includes('const BUILD_REV = "20260913-assistarchive156"'));
