...
assert.strictEqual(version.displayVersion, '195');
assert.strictEqual(version.latestBuild, '20260917-anonfixtures195');
assert(index.includes("const BUILD_REV='20260917-anonfixtures195'"));
assert(sw.includes('const BUILD_REV = "20260917-anonfixtures195"'));
