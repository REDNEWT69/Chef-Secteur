...
assert.strictEqual(version.latestBuild, '20260917-aicontext196');
assert(index.includes("const BUILD_REV='20260917-aicontext196'"));
assert(sw.includes('const BUILD_REV = "20260917-aicontext196"'));
