...
assert.strictEqual(version.displayVersion, '185');
assert.strictEqual(version.latestBuild, '20260915-routeovernight185');
assert(index.includes("const BUILD_REV='20260915-routeovernight185'"));
assert(sw.includes('const BUILD_REV = "20260915-routeovernight185"'));
