...
assert(index.includes("const BUILD_REV='20260917-overnightbadge203'"),'index doit publier le build V203');
assert(sw.includes('const BUILD_REV = "20260917-overnightbadge203"'),'sw doit publier le même build V203');
assert.equal(version.latestBuild,'20260917-overnightbadge203');
assert.equal(version.displayVersion,'203');
...
assert(index.includes('<img src="./app-icon.svg?rev=20260917-overnightbadge203" alt="S-RUNNER">'),'le loader doit afficher le vrai logo S-RUNNER');
