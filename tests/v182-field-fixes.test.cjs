...
assert(index.includes("const BUILD_REV='20260916-storecontrol189'"),'index doit publier le build V189');
assert(sw.includes('const BUILD_REV = "20260916-storecontrol189"'),'sw doit publier le même build V189');
assert.equal(version.latestBuild,'20260916-storecontrol189');
assert.equal(version.displayVersion,'189');
...
assert(index.includes('<img src="./app-icon.svg?rev=20260916-storecontrol189" alt="S-RUNNER">'),'le loader doit afficher le vrai logo S-RUNNER');
