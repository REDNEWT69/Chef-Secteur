...
assert(index.includes("const BUILD_REV='20260917-storereconcile209'"),'index doit publier le build V208');
assert(sw.includes('const BUILD_REV = "20260917-storereconcile209"'),'sw doit publier le même build V208');
assert.equal(version.latestBuild,'20260917-storereconcile209');
assert.equal(version.displayVersion,'209');
...
assert(index.includes('<img src="./app-icon.svg?rev=20260917-storereconcile209" alt="S-RUNNER">'),'le loader doit afficher le vrai logo S-RUNNER');
