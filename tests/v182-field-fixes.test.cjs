...
assert(index.includes("const BUILD_REV='20260917-photomove201'"),'index doit publier le build V201');
assert(sw.includes('const BUILD_REV = "20260917-photomove201"'),'sw doit publier le même build V201');
assert.equal(version.latestBuild,'20260917-photomove201');
assert.equal(version.displayVersion,'201');
...
assert(index.includes('<img src="./app-icon.svg?rev=20260917-photomove201" alt="S-RUNNER">'),'le loader doit afficher le vrai logo S-RUNNER');
