...
assert(index.includes("const BUILD_REV='20260917-aicontext196'"),'index doit publier le build V196');
assert(sw.includes('const BUILD_REV = "20260917-aicontext196"'),'sw doit publier le même build V196');
assert.equal(version.latestBuild,'20260917-aicontext196');
...
assert(index.includes('<img src="./app-icon.svg?rev=20260917-aicontext196" alt="S-RUNNER">'),'le loader doit afficher le vrai logo S-RUNNER');
