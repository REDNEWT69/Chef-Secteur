...
assert(index.includes("const BUILD_REV='20260917-glassnearby202'"),'index doit publier le build V202');
assert(sw.includes('const BUILD_REV = "20260917-glassnearby202"'),'sw doit publier le même build V202');
assert.equal(version.latestBuild,'20260917-glassnearby202');
assert.equal(version.displayVersion,'202');
...
assert(index.includes('<img src="./app-icon.svg?rev=20260917-glassnearby202" alt="S-RUNNER">'),'le loader doit afficher le vrai logo S-RUNNER');
