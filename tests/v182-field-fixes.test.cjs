...
assert(index.includes("const BUILD_REV='20260917-nearbysuggest199'"),'index doit publier le build V199');
assert(sw.includes('const BUILD_REV = "20260917-nearbysuggest199"'),'sw doit publier le même build V199');
assert.equal(version.latestBuild,'20260917-nearbysuggest199');
assert.equal(version.displayVersion,'199');
...
assert(index.includes('<img src="./app-icon.svg?rev=20260917-nearbysuggest199" alt="S-RUNNER">'),'le loader doit afficher le vrai logo S-RUNNER');
