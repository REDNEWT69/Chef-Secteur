...
assert(index.includes("const BUILD_REV='20260917-nightcue206'"),'index doit publier le build V206');
assert(sw.includes('const BUILD_REV = "20260917-nightcue206"'),'sw doit publier le même build V206');
assert.equal(version.latestBuild,'20260917-nightcue206');
...
assert(index.includes('<img src="./app-icon.svg?rev=20260917-nightcue206" alt="S-RUNNER">'),'le loader doit afficher le vrai logo S-RUNNER');
