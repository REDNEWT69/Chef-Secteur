...
assert(index.includes("const BUILD_REV='20260917-daytabs207'"),'index doit publier le build V207');
assert(sw.includes('const BUILD_REV = "20260917-daytabs207"'),'sw doit publier le même build V207');
assert.equal(version.latestBuild,'20260917-daytabs207');
...
assert(index.includes('<img src="./app-icon.svg?rev=20260917-daytabs207" alt="S-RUNNER">'),'le loader doit afficher le vrai logo S-RUNNER');
