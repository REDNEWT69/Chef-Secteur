...
assert(index.includes("const BUILD_REV='20260917-planningtoday205'"),'index doit publier le build V205');
assert(sw.includes('const BUILD_REV = "20260917-planningtoday205"'),'sw doit publier le même build V205');
assert.equal(version.latestBuild,'20260917-planningtoday205');
assert.equal(version.displayVersion,'205');
...
assert(index.includes('<img src="./app-icon.svg?rev=20260917-planningtoday205" alt="S-RUNNER">'),'le loader doit afficher le vrai logo S-RUNNER');
