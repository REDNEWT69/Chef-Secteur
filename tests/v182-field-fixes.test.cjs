...
assert(index.includes("const BUILD_REV='20260916-cuisiniste193'"),'index doit publier le build V193');
assert(sw.includes('const BUILD_REV = "20260916-cuisiniste193"'),'sw doit publier le même build V193');
assert.equal(version.latestBuild,'20260916-cuisiniste193');
assert.equal(version.displayVersion,'193');
...
assert(index.includes('<img src="./app-icon.svg?rev=20260916-cuisiniste193" alt="S-RUNNER">'),'le loader doit afficher le vrai logo S-RUNNER');
