...
test('V193 affiche le contrat expo Rhône-Alpes à 390 px sans toucher au planning',async({page})=>{
  ...
  const result=await page.evaluate(()=>{
    ...
    const store={id:'cui-e2e',enseigne:'Schmidt',ville:'Saint-Priest',adresse:'1 rue Test',priority:4,active:true};
    ...
    A.saveTracking(db,{type:'tracking',sector:'Auvergne-Rhone-Alpes',importedAt:'2026-09-16T12:00:00Z',sites:[{
      key:'SCH-SAINT-PRIEST FR-69800',brand:'SCHMIDT',city:'SAINT-PRIEST',cityKey:'saint priest',postal:'69800',label:'SCH-SAINT-PRIEST FR-69800',
      activeContract:{sector:'Valence',brand:'SCHMIDT',city:'SAINT-PRIEST',clientNumber:'111',startDate:'2026-03-01',endDate:'2027-02-28',status:'En cours',objective:7200,realized:6300,progress:.875,monthsRemaining:6,closure:'25%',toInvoice:150,portfolio:1200,products:['BRBTEST']},
